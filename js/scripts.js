...
var date0fBirth = new Date(year + "/" + month + "/" + date);
...
// var bornDay;
    if (gender == "female" && validDay==true && validMonth==true ) {
           // bornDay = "Sunday";
           document.getElementById("output").innerHTML = "You were born on " + dayOfWeek[results] + " and Your Akan name is "  + femaleArray[results];
           return true;

       } else if ( gender == "male"  && validDay==true && validMonth==true ) {
           // bornDay = "Sunday";
           document.getElementById("output").innerHTML = "You were born on " + dayOfWeek[results] + " and your Akan name is "  + maleArray[results];
           return true;
